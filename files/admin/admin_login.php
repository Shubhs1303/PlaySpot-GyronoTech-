    ...
    <img src="../img/[removal.ai]_7e2a2cf3-a147-4bb2-889a-b8616d3836df-image.png" alt="">
        ...
        <form method="POST" action="admin_log.php">
            <h2>Admin Login</h2>
                ...
                <div class="pass-txt"><a href="../frogot_password/forgot.html">Forgot password?</a></div>
                <input type="submit" value="Login" name="login">

        </form>
        <div class="sign-txt">Not yet member? <a href="admin_register.php">Signup now</a></div>
